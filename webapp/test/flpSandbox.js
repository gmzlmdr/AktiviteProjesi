		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "aktivite",
									"targetURL": "#comgalemdaraktiviteproje-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comgalemdaraktiviteproje-display": {
								"semanticObject": "comgalemdaraktiviteproje",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.galemdar.aktiviteproje",
									"url": sap.ui.require.toUrl("com/galemdar/aktiviteproje")
								}
							}
						}
					}
